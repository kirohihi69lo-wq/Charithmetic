...
# BigParallelWorker v3 (Charithmeticベース, match/case, matmul/fft/ifft/conv/dot/sum/reduces対応)
...
class BigParallelWorker:
    ...
    def fft(self, seq):
        ...
        # 大規模はセグメントFFT→結合は上位で扱う想定(フック優先)
        return _dft(seq, inverse=False)
